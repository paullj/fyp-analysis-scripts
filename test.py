...
# %% Define variables
# Sweep settings
min_freq = 1e5       # Sweep start frequency (Hz)
...
(freq, Z) = model.get_impedance(epsilon_33, c_33, e_33, rho, A, t, delta_e, delta_m, min_freq=min_freq, max_freq=max_freq, num_points=num_points)
k = t/A
